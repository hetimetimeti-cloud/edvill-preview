...
const referenceProjects=[
  {key:'terasz',name:'Terasz',tag:'Kültéri fény',image:'assets/references/terasz.jpg?v=20260817-1038',lead:'Meleg, visszafogott fény a terasz használható és hangulatos esti teréhez.',detail:'Kültéri világítás · meleg fény · esti hangulat'},
  {key:'konyha',name:'Konyha',tag:'Munkafény',image:'assets/references/konyha.jpg?v=20260817-1038',lead:'Pontosan oda kerül fény, ahol dolgozol — a háttérben pedig megmarad az otthonos hangulat.',detail:'Pultvilágítás · LED profil · funkcionális fény'},
  {key:'rgb',name:'RGB világítás',tag:'Színes hangulat',image:'assets/references/rgb.jpg?v=20260817-1038',lead:'Színes, vezérelhető fények olyan terekhez, ahol a hangulat is része az élménynek.',detail:'RGB LED · vezérlés · dinamikus fény'},
  {key:'szorakozohely',name:'Szórakozóhely',tag:'Atmoszféra',image:'assets/references/szorakozohely.jpg?v=20260817-1038',lead:'A fény itt nem háttér: meghatározza az egész hely karakterét és ritmusát.',detail:'Dekorfény · hangulatvilágítás · karakter'},
  {key:'kert',name:'Kerti világítás',tag:'Kültér',image:'assets/references/kert.jpg?v=20260817-1038',lead:'Biztonság, irányfény és atmoszféra egy rendszerben, kültéri környezetre tervezve.',detail:'Kültéri LED · járdafény · hangulat'},
  {key:'furdoszoba',name:'Fürdőszoba',tag:'Funkcionális fény',image:'assets/references/furdoszoba.jpg?v=20260817-1038',lead:'Tiszta, jól használható fény a tükörnél és finom háttérvilágítás a térben.',detail:'Tükörfény · rejtett LED · IP-védelem'},
  {key:'mennyezet',name:'Mennyezeti LED',tag:'Rejtett fény',image:'assets/references/mennyezeti-led.jpg?v=20260817-1038',lead:'A fényforrás eltűnik, a fény viszont építészeti elemmé válik.',detail:'Fényvonal · rejtett LED · indirekt fény'},
  {key:'haloszoba',name:'Hálószoba',tag:'Indirekt fény',image:'assets/references/haloszoba.jpg?v=20260817-1038',lead:'Lágy, rétegzett fény a pihenéshez — rejtett világítással és visszafogott esti hangulattal.',detail:'Indirekt LED · meleg fény · nyugodt hangulat'}
];
