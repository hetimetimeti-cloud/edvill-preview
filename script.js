...
function applyHQVideo(){
  ...
  [heroVideo,...lightingVideos].forEach(v=>{if(!v)return;v.src=url;v.preload='auto';v.load()});
...
const referenceProjects=[
  {key:'terasz',name:'Terasz',tag:'Kültéri fény',image:'https://edvill.hu/wp-content/uploads/2024/09/IMG_20240808_200700-scaled.jpg',lead:'Meleg, visszafogott fény a terasz használható és hangulatos esti teréhez.',detail:'Kültéri világítás · meleg fény · esti hangulat'},
  {key:'konyha',name:'Konyha',tag:'Munkafény',image:'https://edvill.hu/wp-content/uploads/2024/09/11423756_994880383931379_774657023032516576_o-1-1024x614-1.jpg',lead:'Pontosan oda kerül fény, ahol dolgozol — a háttérben pedig megmarad az otthonos hangulat.',detail:'Pultvilágítás · LED profil · funkcionális fény'},
  {key:'rgb',name:'RGB világítás',tag:'Színes hangulat',image:'https://edvill.hu/wp-content/uploads/2024/09/IMG_9521-1024x576-1.jpg',lead:'Színes, vezérelhető fények olyan terekhez, ahol a hangulat is része az élménynek.',detail:'RGB LED · vezérlés · dinamikus fény'},
  {key:'szorakozohely',name:'Szórakozóhely',tag:'Atmoszféra',image:'https://edvill.hu/wp-content/uploads/2024/07/448985721_1218784492872350_2689812110299741548_n-edited.jpg',lead:'A fény itt nem háttér: meghatározza az egész hely karakterét és ritmusát.',detail:'Dekorfény · hangulatvilágítás · karakter'},
  {key:'kert',name:'Kerti világítás',tag:'Kültér',image:'https://edvill.hu/wp-content/uploads/2024/08/20201213_160905-1-scaled.jpg',lead:'Biztonság, irányfény és atmoszféra egy rendszerben, kültéri környezetre tervezve.',detail:'Kültéri LED · járdafény · hangulat'},
  {key:'furdoszoba',name:'Fürdőszoba',tag:'Funkcionális fény',image:'assets/references/furdoszoba.jpg?v=20260817-1004',lead:'Tiszta, jól használható fény a tükörnél és finom háttérvilágítás a térben.',detail:'Tükörfény · rejtett LED · IP-védelem'},
  {key:'mennyezet',name:'Mennyezeti LED',tag:'Rejtett fény',image:'https://edvill.hu/wp-content/uploads/2024/08/20201213_160905-1-1024x512.jpg',lead:'A fényforrás eltűnik, a fény viszont építészeti elemmé válik.',detail:'Fényvonal · rejtett LED · indirekt fény'},
  {key:'polc',name:'Beépített polc',tag:'Kiemelő fény',image:'https://edvill.hu/wp-content/uploads/2024/08/20201213_160915-1-1024x512.jpg',lead:'Finom részletfény, amely kiemeli az anyagokat és mélységet ad a bútorozott térnek.',detail:'Bútorvilágítás · kiemelő fény · LED profil'}
];
